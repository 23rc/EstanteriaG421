...
export class EstanteriaComponent {
  ...
  estanteria3: string[][] = [
    ...
    ['RUBIO - LUNDBECK - BIOHERAPY - FARMAVIC - LABORATORIOS SIERRA - AB-BOTICS - QUIMIFAR', 'MALTES - LION PHARMA - GOLD FOREST - INFARMA - SNC PHARMA - EUROMED ', 'ITALBIOTIC - ETIK PROACUA, CALOX', 'PHARMACROSS - SAN LUIS', 'BOEHRINGER - TERAMED ', 'NOVEMED - CHINOIN - ONSITE', 'GLAXO SMITH KLINE ', 'SANOFI', 'SANOFI'],
