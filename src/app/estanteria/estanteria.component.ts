...
export class EstanteriaComponent implements AfterViewInit {
  ...
  estanteria2: string[][] = [
    ...
    ['REWARD', 'GLAXO POPULAR', 'BAYER POPULAR', 'BAYER POPULAR.', 'BAYER POPULAR', 'BDF CENTROAMERICA - UNILIVER', 'IMEXA - CATALYSIS - AVENE - GALDERMA - DIADERM LABORATORIOS - BATAB HEALTH', 'DERMIX - BABE - SEBAPHARMA - CUMLAUDE LAB', 'MEGALABS (MEDIHEALTH)'],
